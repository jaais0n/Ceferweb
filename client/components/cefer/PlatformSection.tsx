...
export function PlatformSection() {
  return (
    <section className="flex flex-col items-center mt-24 w-full max-md:mt-10 max-md:max-w-full">
      <div className="self-stretch w-full aspect-[2.28] bg-gradient-to-br from-[#eef4ff] to-[#f5f0ff] border border-[#dde8f8] rounded-2xl shadow-[0px_24px_24px_rgba(55,52,169,0.3)] max-md:max-w-full" />
      ...
      <div className="mt-72 max-w-full w-[832px] aspect-[4.18] bg-gradient-to-br from-[#eef4ff] to-[#f5f0ff] border border-[#dde8f8] rounded-2xl max-md:mt-10" />

      <div className="self-stretch mt-48 w-full aspect-[9.9] bg-gradient-to-br from-[#eef4ff] to-[#f5f0ff] border border-[#dde8f8] rounded-2xl max-md:mt-10 max-md:max-w-full" />
    </section>
  );
}
