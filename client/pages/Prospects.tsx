    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
            What Is <span className="text-gradient-cefer">Prospector?</span>
          </h2>
      ...
      <section className="py-20 px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">Everything you need to find your perfect prospects</p>
          ...
          <div className="py-2">
            ...
            <div className="grid md:grid-cols-3 gap-5 mt-10">
              ...
              <div className="bg-white rounded-2xl p-7 text-center border border-[#e8f0fe] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                ...
                <div className="text-4xl font-bold text-[#0e7bf5] mb-1">53%</div>
                <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Higher Response</div>
              </div>
              <div className="bg-white rounded-2xl p-7 text-center border border-[#e8f0fe] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                <div className="w-16 h-16 bg-[#eef5ff] rounded-2xl flex items-center justify-center mx-auto mb-5">
                ...
                <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">Setup Time</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ul className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto text-left space-y-3 list-disc list-inside">
            <li>Spend less time searching and more time selling</li>
            <li>Access verified, up-to-date prospect data instantly</li>
            <li>Maintain a healthy, predictable sales pipeline</li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-20 px-8 relative overflow-hidden" style={{ backgroundImage: "url(/bgcase.png)", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-10">
            Find and connect with verified B2B decision-makers in minutes.
          </p>
