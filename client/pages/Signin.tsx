        ...
        <Card className="w-full max-w-md border-none shadow-xl rounded-3xl overflow-hidden p-4">
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input id="email" type="email" placeholder="m@example.com" className="rounded-xl h-12" />
            </div>
            <div className="grid gap-2">
            ...
            <Button className="w-full h-12 rounded-full bg-[#0e7bf5] hover:bg-blue-600 text-white font-semibold transition-all mt-2">
              Sign In
            </Button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="h-12 rounded-xl border-gray-200 hover:bg-gray-50 flex items-center gap-2">
